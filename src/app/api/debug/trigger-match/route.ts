            ...
            try {
              ...
              webhookResult = await notifyDtcOfMatchProposed(
                newMatch.id,
                {
                  ...
                  desiredCentreIds: Array.isArray(listing.desiredCentreIds) ? listing.desiredCentreIds : [],
                ...
                },
                {
                  ...
                  desiredCentreIds: Array.isArray(candidate.desiredCentreIds) ? candidate.desiredCentreIds : [],

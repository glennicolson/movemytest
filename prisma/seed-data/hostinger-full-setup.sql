-- MoveMyTest Hostinger Database Setup
-- Generated: 2026-05-28T19:27:41.993Z
...
CREATE TABLE `InstructorAvailabilityDecision` (
    ...
    INDEX `InstrAvailDec_instructorAccountId_status_decidedAt_idx`(`instructorAccountId`, `status`, `decidedAt`),
...
CREATE TABLE `Match` (
    ...
    `status` ENUM('PROPOSED', 'ACCEPTED', 'DECLINED', 'EXPIRED', 'CONFIRMED', 'BOOKING_REFERENCE_SHARED', 'COMPLETED', 'REPORTED') NOT NULL DEFAULT 'PROPOSED',
...
-- Default admin account: support@movemytest.co.uk / M0v3mYt35t
INSERT INTO `StaffAccount` (`id`, `email`, `passwordHash`, `name`, `role`, `createdAt`, `updatedAt`) VALUES ('cmq1test0000admin001', 'support@movemytest.co.uk', '9734248be4e721fd945d511d2e6b051f.8dc1bd753ab98e95dd0e1e2508117fca09f57f9ead2f34a38f5d9914049190523f1bf9f5596db36c1c6b32ae35061c0c4f2f9d0916bbc8c99bdad09f2e7cacb1', 'Support Team', 'ADMIN', NOW(), NOW());
